CREATE TABLE `localidades` (
  ...
  `municipio_id` int NOT NULL COMMENT 'Relación con municipios.id',
  ...
  `mapa` int NOT NULL COMMENT 'Mapa - Identificador del INEGI',
  ...
  `poblacion` int NOT NULL COMMENT 'Pob_Total – Población Total',
  `masculino` int NOT NULL COMMENT 'Pob_Masculina – Población Masculina',
  `femenino` int NOT NULL COMMENT 'Pob_Femenina – Población Femenina',
  `viviendas` int NOT NULL COMMENT 'Total De Viviendas Habitadas',
  `activo` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `municipio_id` (`municipio_id`),
  CONSTRAINT `fk_localidades_municipios` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Tabla de Localidades de la Republica Mexicana';
